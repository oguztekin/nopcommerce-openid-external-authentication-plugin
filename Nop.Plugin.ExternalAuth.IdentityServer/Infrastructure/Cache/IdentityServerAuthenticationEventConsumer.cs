...
namespace Nop.Plugin.ExternalAuth.IdentityServer.Infrastructure.Cache
{
    /// <summary>
    /// Facebook authentication event consumer (used for saving customer fields on registration)
    /// </summary>
    public partial class IdentityServerAuthenticationEventConsumer : IConsumer<CustomerAutoRegisteredByExternalMethodEvent>
    {
        #region Fields
        ...
        public IdentityServerAuthenticationEventConsumer(IGenericAttributeService genericAttributeService)
        {
        ...
        public void HandleEvent(CustomerAutoRegisteredByExternalMethodEvent eventMessage)
        {
            ...
            if (!eventMessage.AuthenticationParameters.ProviderSystemName.Equals(IdentityServerAuthenticationDefaults.ProviderSystemName))
                return;
